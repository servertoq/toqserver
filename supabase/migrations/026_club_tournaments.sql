...
CREATE INDEX IF NOT EXISTS club_tournaments_community_idx
  ON public.club_tournaments (community_id, sort_order);

CREATE INDEX IF NOT EXISTS club_tournaments_public_idx
...
DROP TRIGGER IF EXISTS club_tournaments_updated_at ON public.club_tournaments;
