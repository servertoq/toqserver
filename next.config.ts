...
const contentSecurityPolicy = [
  ...
  "font-src 'self' data:",
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://maps.googleapis.com https://*.googleapis.com https://places.googleapis.com https://api.stripe.com https://api.mercadopago.com https://api.mercadolibre.com https://viacep.com.br https://brasilapi.com.br https://api.bigdatacloud.net https://nominatim.openstreetmap.org https://api.resend.com",
